...
class Level_UnlockPickup(RoomGridLevel):
    ...
    def __init__(self,room_size=6, distractors=False, seed=None):
        self.distractors = distractors
        super().__init__(
            num_rows=1,
            num_cols=2,
    ...
    def set_roomsize(self, room_size):
        #self.room_size = room_size
        #self.max_steps = 8 * self.room_size ** 2
        #self.gen_mission()
        super().__init__(
            num_rows=1,
            num_cols=2,
...
class Level_OpenTwoDoors(RoomGridLevel):
    ...
    def __init__(self, room_size=6, first_color=None, second_color=None, seed=None):
